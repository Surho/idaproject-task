...
var regexNumber = /^[0-9]*$/;
var regexLatinic = /^[a-zA-Z]+$/;

$('input[name^="serial"]').keypress(function (evt) {
...
$('#cvv-code').keypress(function (evt) {
...
$('input[name="card-holder"').keypress(function (evt) {
...
__webpack_require__(/*! ./jquery.form-validator.min.js */ "./src/js/jquery.form-validator.min.js");

__webpack_require__(/*! ./forms.js */ "./src/js/forms.js");

__webpack_require__(/*! ./classList-polyfill.js */ "./src/js/classList-polyfill.js");
...
!function (a, b) {
  ...
  !function (a, b, c) {
          ...
          var e = a.split(b),
            ...
            if (d = a.trim(d), 0 === d.length || a.formUtils.hasLoadedModule(d)) g();else {
              var e = c + d + (".js" === d.slice(-3) ? "" : ".js"),
                  f = document.createElement("SCRIPT"); true ? __webpack_require__.e(/*! AMD require */ 0).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__("./src/js sync recursive")(e + (".dev.js" === e.slice(-7) ? h : ""))]; (g).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__);}.bind(this)).catch(__webpack_require__.oe) : (undefined);
            }
          });
        };if (c) e(b, c);else {
          var f = function f() {
    ...
    var c = a(b);a.formUtils = a.extend(a.formUtils || {}, { $win: c, defaultConfig: function defaultConfig() {
      ...
      }, validators: {}, sanitizers: {}, _events: { load: [], valid: [], invalid: [] }, haltValidation: !1, addValidator: function addValidator(a) {
...
(0, _jquery2.default)(document).ready(function () {
    (0, _jquery2.default)('.nav').click(function (evt) {
        ...
        if (elem.classList.contains('nav__item') && !elem.classList.contains('nav__item--exit')) {
            ...
            var tab = (0, _jquery2.default)(elem).data('tab');
